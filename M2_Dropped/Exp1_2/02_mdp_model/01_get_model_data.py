...
PROGRAM_LIST = [
    "02_mdp_model/mdp_boredom.py",
    "02_mdp_model/mdp_fear.py",
    "02_mdp_model/mdp_happiness.py",
    "02_mdp_model/mdp_joy.py",
    "02_mdp_model/mdp_pride.py",
    "02_mdp_model/mdp_sadness.py",
    "02_mdp_model/mdp_shame.py",
]
...
def main() -> None:
    print(f"Running Exp1_2 model extraction for MODEL_TYPE={MODEL_TYPE!r}")

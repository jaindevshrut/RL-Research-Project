...
SETTINGS = {
    "free": {
        "human_path": DATA_DIR / "human_free_limit.csv",
        "human_prefix": "Emo.",
        "legacy_output": DATA_DIR / "svm_free_0.0013_var.csv",
        ...
        "sample_size": 34,
        "sample_loc": 13,
        "sample_scale": np.sqrt(1),
    },
    "limit": {
        "human_path": DATA_DIR / "human_free_limit.csv",
        "human_prefix": "mc.",
        "legacy_output": DATA_DIR / "svm_limit_0.0034_var.csv",
